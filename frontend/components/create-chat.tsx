          ...
          <div>
            ...
            <ul className="space-y-2">
              {chatList.map((chat, index) => (
                <li onClick={() => router.push(`/chat/${chat.id}`)} key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors cursor-pointer">
