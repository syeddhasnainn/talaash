...
export default function SearchBar({
  ...
  const { question, setRelatedQuestions, setAnswer, setResults, isWebAccess } = useStore();
  ...
  return (
    <div className="flex flex-col">
      ...
      <label className="inline-flex items-center cursor-pointer">
        ...
        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Internet access</span>
      </label>
      <form
